...
public class GEBTActivity extends AppCompatActivity implements View.OnClickListener {
    public Button Bttn1,Bttn2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gebt);
        ...
        Bttn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GEBTActivity.this,GEBT_StudentActivity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.TeacherroomId){
            ...
            Intent intent = new Intent(GEBTActivity.this,GEBT_TeacherActivity.class);
            startActivity(intent);
        }
