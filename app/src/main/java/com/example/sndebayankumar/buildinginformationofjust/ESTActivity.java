...
public class ESTActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bttn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ESTActivity.this,EST_StudentActivity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.TeacherroomId){
            ...
            Intent intent = new Intent(ESTActivity.this,EST_TeacherActivity.class);
            startActivity(intent);
        }
