...
public class BMEActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bttn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BMEActivity.this,BME_StudentActivity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.TeacherroomId){
            ...
            Intent intent = new Intent(BMEActivity.this,BME_TeacherActivity.class);
            startActivity(intent);
        }
    }
}
