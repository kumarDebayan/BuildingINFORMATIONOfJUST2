...
public class IPEActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bttn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(IPEActivity.this,IPE_StudentActivity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.TeacherroomId){
            ...
            Intent intent = new Intent(IPEActivity.this,IPE_TeacherActivity.class);
            startActivity(intent);
        }
