...
public class APPTActivity extends AppCompatActivity implements View.OnClickListener {
  public Button Bttn1,Bttn2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bttn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(APPTActivity.this,APPT_StudentActivity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.TeacherroomId){
            ...
            Intent intent = new Intent(APPTActivity.this,APPT_TeacherActivity.class);
            startActivity(intent);
        }
